...
object Instructions {
  val IType = Map(
    ...
    "SND" -> BitPat("b0000011??????????100?????0110011"), //send added by akamatsu
    "RCV" -> BitPat("b0000111??????????100?????0110011"), //receive added by akamatsu
  )
  val ZPNType = Map(
    "ADD16" -> BitPat("b0100000??????????000?????1110111"),
    "ADD8" -> BitPat("b0100100??????????000?????1110111"),
    "AVE" -> BitPat("b1110000??????????000?????1110111"),
    "CLROV" -> BitPat("b00000000100100001111?????1110011"),
    "CLRS16" -> BitPat("b101011101000?????000?????1110111"),
    "CLRS32" -> BitPat("b101011111000?????000?????1110111"),
    "CLRS8" -> BitPat("b101011100000?????000?????1110111"),
    "CLZ16" -> BitPat("b101011101001?????000?????1110111"),
    "CLZ32" -> BitPat("b101011111001?????000?????1110111"),
    "CLZ8" -> BitPat("b101011100001?????000?????1110111"),
    "CMPEQ16" -> BitPat("b0100110??????????000?????1110111"),
    "CMPEQ8" -> BitPat("b0100111??????????000?????1110111"),
    "CRAS16" -> BitPat("b0100010??????????000?????1110111"),
    "CRSA16" -> BitPat("b0100011??????????000?????1110111"),
    "KABS16" -> BitPat("b101011010001?????000?????1110111"),
    "KABS8" -> BitPat("b101011010000?????000?????1110111"),
    "KABSW" -> BitPat("b101011010100?????000?????1110111"),
    "KADD16" -> BitPat("b0001000??????????000?????1110111"),
    "KADD8" -> BitPat("b0001100??????????000?????1110111"),
    "KADDH" -> BitPat("b0000010??????????001?????1110111"),
    "KADDW" -> BitPat("b0000000??????????001?????1110111"),
    "KCRAS16" -> BitPat("b0001010??????????000?????1110111"),
    "KCRSA16" -> BitPat("b0001011??????????000?????1110111"),
    "KDMABB" -> BitPat("b1101001??????????001?????1110111"),
    "KDMABT" -> BitPat("b1110001??????????001?????1110111"),
    "KDMATT" -> BitPat("b1111001??????????001?????1110111"),
    "KDMBB" -> BitPat("b0000101??????????001?????1110111"),
    "KDMBT" -> BitPat("b0001101??????????001?????1110111"),
    "KDMTT" -> BitPat("b0010101??????????001?????1110111"),
    "KHM16" -> BitPat("b1000011??????????000?????1110111"),
    "KHM8" -> BitPat("b1000111??????????000?????1110111"),
    "KHMBB" -> BitPat("b0000110??????????001?????1110111"),
    "KHMBT" -> BitPat("b0001110??????????001?????1110111"),
    "KHMTT" -> BitPat("b0010110??????????001?????1110111"),
    "KHMX16" -> BitPat("b1001011??????????000?????1110111"),
    "KHMX8" -> BitPat("b1001111??????????000?????1110111"),
    "KMABB" -> BitPat("b0101101??????????001?????1110111"),
    "KMABT" -> BitPat("b0110101??????????001?????1110111"),
    "KMADA" -> BitPat("b0100100??????????001?????1110111"),
    "KMADRS" -> BitPat("b0110110??????????001?????1110111"),
    "KMADS" -> BitPat("b0101110??????????001?????1110111"),
    "KMATT" -> BitPat("b0111101??????????001?????1110111"),
    "KMAXDA" -> BitPat("b0100101??????????001?????1110111"),
    "KMAXDS" -> BitPat("b0111110??????????001?????1110111"),
    "KMDA" -> BitPat("b0011100??????????001?????1110111"),
    "KMMAC" -> BitPat("b0110000??????????001?????1110111"),
    "KMMAC_U" -> BitPat("b0111000??????????001?????1110111"),
    "KMMAWB" -> BitPat("b0100011??????????001?????1110111"),
    "KMMAWB2" -> BitPat("b1100111??????????001?????1110111"),
    "KMMAWB2_U" -> BitPat("b1101111??????????001?????1110111"),
    "KMMAWB_U" -> BitPat("b0101011??????????001?????1110111"),
    "KMMAWT" -> BitPat("b0110011??????????001?????1110111"),
    "KMMAWT2" -> BitPat("b1110111??????????001?????1110111"),
    "KMMAWT2_U" -> BitPat("b1111111??????????001?????1110111"),
    "KMMAWT_U" -> BitPat("b0111011??????????001?????1110111"),
    "KMMSB" -> BitPat("b0100001??????????001?????1110111"),
    "KMMSB_U" -> BitPat("b0101001??????????001?????1110111"),
    "KMMWB2" -> BitPat("b1000111??????????001?????1110111"),
    "KMMWB2_U" -> BitPat("b1001111??????????001?????1110111"),
    "KMMWT2" -> BitPat("b1010111??????????001?????1110111"),
    "KMMWT2_U" -> BitPat("b1011111??????????001?????1110111"),
    "KMSDA" -> BitPat("b0100110??????????001?????1110111"),
    "KMSXDA" -> BitPat("b0100111??????????001?????1110111"),
    "KMXDA" -> BitPat("b0011101??????????001?????1110111"),
    "KSLL16" -> BitPat("b0110010??????????000?????1110111"),
    "KSLL8" -> BitPat("b0110110??????????000?????1110111"),
    "KSLLI16" -> BitPat("b01110101?????????000?????1110111"),
    "KSLLI8" -> BitPat("b011111001????????000?????1110111"),
    "KSLLIW" -> BitPat("b0011011??????????001?????1110111"),
    "KSLLW" -> BitPat("b0010011??????????001?????1110111"),
    "KSLRA16" -> BitPat("b0101011??????????000?????1110111"),
    "KSLRA16_U" -> BitPat("b0110011??????????000?????1110111"),
    "KSLRA8" -> BitPat("b0101111??????????000?????1110111"),
    "KSLRA8_U" -> BitPat("b0110111??????????000?????1110111"),
    "KSLRAW" -> BitPat("b0110111??????????001?????1110111"),
    "KSLRAW_U" -> BitPat("b0111111??????????001?????1110111"),
    "KSTAS16" -> BitPat("b1100010??????????010?????1110111"),
    "KSTSA16" -> BitPat("b1100011??????????010?????1110111"),
    "KSUB16" -> BitPat("b0001001??????????000?????1110111"),
    "KSUB8" -> BitPat("b0001101??????????000?????1110111"),
    "KSUBH" -> BitPat("b0000011??????????001?????1110111"),
    "KSUBW" -> BitPat("b0000001??????????001?????1110111"),
    "KWMMUL" -> BitPat("b0110001??????????001?????1110111"),
    "KWMMUL_U" -> BitPat("b0111001??????????001?????1110111"),
    "MADDR32" -> BitPat("b1100010??????????001?????1110111"),
    "MSUBR32" -> BitPat("b1100011??????????001?????1110111"),
    "PBSAD" -> BitPat("b1111110??????????000?????1110111"),
    "PBSADA" -> BitPat("b1111111??????????000?????1110111"),
    "PKBT16" -> BitPat("b0001111??????????001?????1110111"),
    "PKTB16" -> BitPat("b0011111??????????001?????1110111"),
    "RADD16" -> BitPat("b0000000??????????000?????1110111"),
    "RADD8" -> BitPat("b0000100??????????000?????1110111"),
    "RADDW" -> BitPat("b0010000??????????001?????1110111"),
    "RCRAS16" -> BitPat("b0000010??????????000?????1110111"),
    "RCRSA16" -> BitPat("b0000011??????????000?????1110111"),
    "RDOV" -> BitPat("b00000000100100000010?????1110011"),
    "RSTAS16" -> BitPat("b1011010??????????010?????1110111"),
    "RSTSA16" -> BitPat("b1011011??????????010?????1110111"),
    "RSUB16" -> BitPat("b0000001??????????000?????1110111"),
    "RSUB8" -> BitPat("b0000101??????????000?????1110111"),
    "RSUBW" -> BitPat("b0010001??????????001?????1110111"),
    "SCLIP16" -> BitPat("b10000100?????????000?????1110111"),
    "SCLIP32" -> BitPat("b1110010??????????000?????1110111"),
    "SCLIP8" -> BitPat("b100011000????????000?????1110111"),
    "SCMPLE16" -> BitPat("b0001110??????????000?????1110111"),
    "SCMPLE8" -> BitPat("b0001111??????????000?????1110111"),
    "SCMPLT16" -> BitPat("b0000110??????????000?????1110111"),
    "SCMPLT8" -> BitPat("b0000111??????????000?????1110111"),
    "SLL16" -> BitPat("b0101010??????????000?????1110111"),
    "SLL8" -> BitPat("b0101110??????????000?????1110111"),
    "SLLI16" -> BitPat("b01110100?????????000?????1110111"),
    "SLLI8" -> BitPat("b011111000????????000?????1110111"),
    "SMAQA" -> BitPat("b1100100??????????000?????1110111"),
    "SMAQA_SU" -> BitPat("b1100101??????????000?????1110111"),
    "SMAX16" -> BitPat("b1000001??????????000?????1110111"),
    "SMAX8" -> BitPat("b1000101??????????000?????1110111"),
    "SMBB16" -> BitPat("b0000100??????????001?????1110111"),
    "SMBT16" -> BitPat("b0001100??????????001?????1110111"),
    "SMDRS" -> BitPat("b0110100??????????001?????1110111"),
    "SMDS" -> BitPat("b0101100??????????001?????1110111"),
    "SMIN16" -> BitPat("b1000000??????????000?????1110111"),
    "SMIN8" -> BitPat("b1000100??????????000?????1110111"),
    "SMMUL_U" -> BitPat("b0101000??????????001?????1110111"),
    "SMMWB" -> BitPat("b0100010??????????001?????1110111"),
    "SMMWB_U" -> BitPat("b0101010??????????001?????1110111"),
    "SMMWT" -> BitPat("b0110010??????????001?????1110111"),
    "SMMWT_U" -> BitPat("b0111010??????????001?????1110111"),
    "SMTT16" -> BitPat("b0010100??????????001?????1110111"),
    "SMXDS" -> BitPat("b0111100??????????001?????1110111"),
    "SRA16" -> BitPat("b0101000??????????000?????1110111"),
    "SRA16_U" -> BitPat("b0110000??????????000?????1110111"),
    "SRA8" -> BitPat("b0101100??????????000?????1110111"),
    "SRA8_U" -> BitPat("b0110100??????????000?????1110111"),
    "SRA_U" -> BitPat("b0010010??????????001?????1110111"),
    "SRAI16" -> BitPat("b01110000?????????000?????1110111"),
    "SRAI16_U" -> BitPat("b01110001?????????000?????1110111"),
    "SRAI8" -> BitPat("b011110000????????000?????1110111"),
    "SRAI8_U" -> BitPat("b011110001????????000?????1110111"),
    "SRL16" -> BitPat("b0101001??????????000?????1110111"),
    "SRL16_U" -> BitPat("b0110001??????????000?????1110111"),
    "SRL8" -> BitPat("b0101101??????????000?????1110111"),
    "SRL8_U" -> BitPat("b0110101??????????000?????1110111"),
    "SRLI16" -> BitPat("b01110010?????????000?????1110111"),
    "SRLI16_U" -> BitPat("b01110011?????????000?????1110111"),
    "SRLI8" -> BitPat("b011110100????????000?????1110111"),
    "SRLI8_U" -> BitPat("b011110101????????000?????1110111"),
    "STAS16" -> BitPat("b1111010??????????010?????1110111"),
    "STSA16" -> BitPat("b1111011??????????010?????1110111"),
    "SUB16" -> BitPat("b0100001??????????000?????1110111"),
    "SUB8" -> BitPat("b0100101??????????000?????1110111"),
    "SUNPKD810" -> BitPat("b101011001000?????000?????1110111"),
    "SUNPKD820" -> BitPat("b101011001001?????000?????1110111"),
    "SUNPKD830" -> BitPat("b101011001010?????000?????1110111"),
    "SUNPKD831" -> BitPat("b101011001011?????000?????1110111"),
    "SUNPKD832" -> BitPat("b101011010011?????000?????1110111"),
    "UCLIP16" -> BitPat("b10000101?????????000?????1110111"),
    "UCLIP32" -> BitPat("b1111010??????????000?????1110111"),
    "UCLIP8" -> BitPat("b100011010????????000?????1110111"),
    "UCMPLE16" -> BitPat("b0011110??????????000?????1110111"),
    "UCMPLE8" -> BitPat("b0011111??????????000?????1110111"),
    "UCMPLT16" -> BitPat("b0010110??????????000?????1110111"),
    "UCMPLT8" -> BitPat("b0010111??????????000?????1110111"),
    "UKADD16" -> BitPat("b0011000??????????000?????1110111"),
    "UKADD8" -> BitPat("b0011100??????????000?????1110111"),
    "UKADDH" -> BitPat("b0001010??????????001?????1110111"),
    "UKADDW" -> BitPat("b0001000??????????001?????1110111"),
    "UKCRAS16" -> BitPat("b0011010??????????000?????1110111"),
    "UKCRSA16" -> BitPat("b0011011??????????000?????1110111"),
    "UKSTAS16" -> BitPat("b1110010??????????010?????1110111"),
    "UKSTSA16" -> BitPat("b1110011??????????010?????1110111"),
    "UKSUB16" -> BitPat("b0011001??????????000?????1110111"),
    "UKSUB8" -> BitPat("b0011101??????????000?????1110111"),
    "UKSUBH" -> BitPat("b0001011??????????001?????1110111"),
    "UKSUBW" -> BitPat("b0001001??????????001?????1110111"),
    "UMAQA" -> BitPat("b1100110??????????000?????1110111"),
    "UMAX16" -> BitPat("b1001001??????????000?????1110111"),
    "UMAX8" -> BitPat("b1001101??????????000?????1110111"),
    "UMIN16" -> BitPat("b1001000??????????000?????1110111"),
    "UMIN8" -> BitPat("b1001100??????????000?????1110111"),
    "URADD16" -> BitPat("b0010000??????????000?????1110111"),
    "URADD8" -> BitPat("b0010100??????????000?????1110111"),
    "URADDW" -> BitPat("b0011000??????????001?????1110111"),
    "URCRAS16" -> BitPat("b0010010??????????000?????1110111"),
    "URCRSA16" -> BitPat("b0010011??????????000?????1110111"),
    "URSTAS16" -> BitPat("b1101010??????????010?????1110111"),
    "URSTSA16" -> BitPat("b1101011??????????010?????1110111"),
    "URSUB16" -> BitPat("b0010001??????????000?????1110111"),
    "URSUB8" -> BitPat("b0010101??????????000?????1110111"),
    "URSUBW" -> BitPat("b0011001??????????001?????1110111"),
    "ZUNPKD810" -> BitPat("b101011001100?????000?????1110111"),
    "ZUNPKD820" -> BitPat("b101011001101?????000?????1110111"),
    "ZUNPKD830" -> BitPat("b101011001110?????000?????1110111"),
    "ZUNPKD831" -> BitPat("b101011001111?????000?????1110111"),
    "ZUNPKD832" -> BitPat("b101011010111?????000?????1110111"),
  )
  val ZPN64Type = Map(
    "ADD32" -> BitPat("b0100000??????????010?????1110111"),
    "CRAS32" -> BitPat("b0100010??????????010?????1110111"),
    "CRSA32" -> BitPat("b0100011??????????010?????1110111"),
    "INSB" -> BitPat("b101011000????????000?????1110111"),
    "KABS32" -> BitPat("b101011010010?????000?????1110111"),
    "KADD32" -> BitPat("b0001000??????????010?????1110111"),
    "KCRAS32" -> BitPat("b0001010??????????010?????1110111"),
    "KCRSA32" -> BitPat("b0001011??????????010?????1110111"),
    "KDMABB16" -> BitPat("b1101100??????????001?????1110111"),
    "KDMABB16" -> BitPat("b1101100??????????001?????1110111"),
    "KDMABT16" -> BitPat("b1110100??????????001?????1110111"),
    "KDMATT16" -> BitPat("b1111100??????????001?????1110111"),
    "KDMBB16" -> BitPat("b1101101??????????001?????1110111"),
    "KDMBT16" -> BitPat("b1110101??????????001?????1110111"),
    "KDMTT16" -> BitPat("b1111101??????????001?????1110111"),
    "KHMBB16" -> BitPat("b1101110??????????001?????1110111"),
    "KHMBT16" -> BitPat("b1110110??????????001?????1110111"),
    "KHMTT16" -> BitPat("b1111110??????????001?????1110111"),
    "KMABB32" -> BitPat("b0101101??????????010?????1110111"),
    "KMABT32" -> BitPat("b0110101??????????010?????1110111"),
    "KMADRS32" -> BitPat("b0110110??????????010?????1110111"),
    "KMADS32" -> BitPat("b0101110??????????010?????1110111"),
    "KMATT32" -> BitPat("b0111101??????????010?????1110111"),
    "KMAXDA32" -> BitPat("b0100101??????????010?????1110111"),
    "KMAXDS32" -> BitPat("b0111110??????????010?????1110111"),
    "KMDA32" -> BitPat("b0011100??????????010?????1110111"),
    "KMSDA32" -> BitPat("b0100110??????????010?????1110111"),
    "KMSXDA32" -> BitPat("b0100111??????????010?????1110111"),
    "KMXDA32" -> BitPat("b0011101??????????010?????1110111"),
    "KSLL32" -> BitPat("b0110010??????????010?????1110111"),
    "KSLLI32" -> BitPat("b1000010??????????010?????1110111"),
    "KSLRA32" -> BitPat("b0101011??????????010?????1110111"),
    "KSLRA32_U" -> BitPat("b0110011??????????010?????1110111"),
    "KSTAS32" -> BitPat("b1100000??????????010?????1110111"),
    "KSTSA32" -> BitPat("b1100001??????????010?????1110111"),
    "KSUB32" -> BitPat("b0001001??????????010?????1110111"),
    "PKBB16" -> BitPat("b0000111??????????001?????1110111"),
    "PKBT32" -> BitPat("b0001111??????????010?????1110111"),
    "PKTB32" -> BitPat("b0011111??????????010?????1110111"),
    "PKTT16" -> BitPat("b0010111??????????001?????1110111"),
    "RADD32" -> BitPat("b0000000??????????010?????1110111"),
    "RCRAS32" -> BitPat("b0000010??????????010?????1110111"),
    "RCRSA32" -> BitPat("b0000011??????????010?????1110111"),
    "RSTAS32" -> BitPat("b1011000??????????010?????1110111"),
    "RSTSA32" -> BitPat("b1011001??????????010?????1110111"),
    "RSUB32" -> BitPat("b0000001??????????010?????1110111"),
    "SLL32" -> BitPat("b0101010??????????010?????1110111"),
    "SLLI32" -> BitPat("b0111010??????????010?????1110111"),
    "SMAX32" -> BitPat("b1001001??????????010?????1110111"),
    "SMBT32" -> BitPat("b0001100??????????010?????1110111"),
    "SMDRS32" -> BitPat("b0110100??????????010?????1110111"),
    "SMDS32" -> BitPat("b0101100??????????010?????1110111"),
    "SMIN32" -> BitPat("b1001000??????????010?????1110111"),
    "SMMUL" -> BitPat("b0100000??????????001?????1110111"),
    "SMTT32" -> BitPat("b0010100??????????010?????1110111"),
    "SMXDS32" -> BitPat("b0111100??????????010?????1110111"),
    "SRA32" -> BitPat("b0101000??????????010?????1110111"),
    "SRA32_U" -> BitPat("b0110000??????????010?????1110111"),
    "SRAI32" -> BitPat("b0111000??????????010?????1110111"),
    "SRAI32_U" -> BitPat("b1000000??????????010?????1110111"),
    "SRAI_U" -> BitPat("b110101???????????001?????1110111"),
    "SRAIW_U" -> BitPat("b0011010??????????001?????1110111"),
    "SRL32" -> BitPat("b0101001??????????010?????1110111"),
    "SRL32_U" -> BitPat("b0110001??????????010?????1110111"),
    "SRLI32" -> BitPat("b0111001??????????010?????1110111"),
    "SRLI32_U" -> BitPat("b1000001??????????010?????1110111"),
    "STAS32" -> BitPat("b1111000??????????010?????1110111"),
    "STSA32" -> BitPat("b1111001??????????010?????1110111"),
    "SUB32" -> BitPat("b0100001??????????010?????1110111"),
    "UKADD32" -> BitPat("b0011000??????????010?????1110111"),
    "UKCRAS32" -> BitPat("b0011010??????????010?????1110111"),
    "UKCRSA32" -> BitPat("b0011011??????????010?????1110111"),
    "UKSTAS32" -> BitPat("b1110000??????????010?????1110111"),
    "UKSTSA32" -> BitPat("b1110001??????????010?????1110111"),
    "UKSUB32" -> BitPat("b0011001??????????010?????1110111"),
    "UMAX32" -> BitPat("b1010001??????????010?????1110111"),
    "UMIN32" -> BitPat("b1010000??????????010?????1110111"),
    "URADD32" -> BitPat("b0010000??????????010?????1110111"),
    "URCRAS32" -> BitPat("b0010010??????????010?????1110111"),
    "URCRSA32" -> BitPat("b0010011??????????010?????1110111"),
    "URSTAS32" -> BitPat("b1101000??????????010?????1110111"),
    "URSTSA32" -> BitPat("b1101001??????????010?????1110111"),
    "URSUB32" -> BitPat("b0010001??????????010?????1110111"),
  )
  val ZPSF32Type = Map(
    "ADD64" -> BitPat("b1100000??????????001?????1110111"),
    "SUB64" -> BitPat("b1100001??????????001?????1110111"),
  )
  val ZBA64Type = Map(
  ...
  val I128Type = Map(
    "ADDD" -> BitPat("b0000000??????????000?????1111011"),
    "ADDID" -> BitPat("b?????????????????000?????1011011"),
    "LDU" -> BitPat("b?????????????????111?????0000011"),
    "LQ" -> BitPat("b?????????????????011?????0001111"),
    "SLLD" -> BitPat("b0000000??????????001?????1111011"),
    "SLLI_RV128" -> BitPat("b00000????????????001?????0010011"),
    "SLLID" -> BitPat("b000000???????????001?????1011011"),
    "SQ" -> BitPat("b?????????????????100?????0100011"),
    "SRAD" -> BitPat("b0100000??????????101?????1111011"),
    "SRAI_RV128" -> BitPat("b01000????????????101?????0010011"),
    "SRAID" -> BitPat("b010000???????????101?????1011011"),
    "SRLD" -> BitPat("b0000000??????????101?????1111011"),
    "SRLI_RV128" -> BitPat("b00000????????????101?????0010011"),
    "SRLID" -> BitPat("b000000???????????101?????1011011"),
    "SUBD" -> BitPat("b0100000??????????000?????1111011"),
  )
  val I64Type = Map(
  ...
  val ZBEType = Map(
    "BCOMPRESS" -> BitPat("b0000100??????????110?????0110011"),
    "BDECOMPRESS" -> BitPat("b0100100??????????110?????0110011"),
    "PACK" -> BitPat("b0000100??????????100?????0110011"),
    "PACKH" -> BitPat("b0000100??????????111?????0110011"),
  )
  val ZBE64Type = Map(
    "BCOMPRESSW" -> BitPat("b0000100??????????110?????0111011"),
    "BDECOMPRESSW" -> BitPat("b0100100??????????110?????0111011"),
    "PACKW" -> BitPat("b0000100??????????100?????0111011"),
  )
  val ZBFType = Map("BFP" -> BitPat("b0100100??????????111?????0110011"))
  val ZBF64Type = Map("BFPW" -> BitPat("b0100100??????????111?????0111011"))
  val ZBM64Type = Map(
    "BMATFLIP" -> BitPat("b011000000011?????001?????0010011"),
    "BMATOR" -> BitPat("b0000100??????????011?????0110011"),
    "BMATXOR" -> BitPat("b0100100??????????011?????0110011"),
    "UNZIP16" -> BitPat("b000010010000?????101?????0010011"),
    "UNZIP8" -> BitPat("b000010011000?????101?????0010011"),
  )
  val ZKSType = Map("BREV8" -> BitPat("b011010000111?????101?????0010011"))
  val CType = Map(
  ...
  val C128Type = Map(
    ...
    "C_LQ" -> BitPat("b????????????????001???????????00"),
    "C_LQSP" -> BitPat("b????????????????001???????????10"),
    "C_SDSP" -> BitPat("b????????????????111???????????10"),
    "C_SQ" -> BitPat("b????????????????101???????????00"),
    "C_SQSP" -> BitPat("b????????????????101???????????10"),
  )
  val C64Type = Map(
  ...
  val C32Type = Map("C_JAL" -> BitPat("b????????????????001???????????01"))
  val ZCBType = Map(
    "C_LBU" -> BitPat("b????????????????100000????????00"),
    "C_LH" -> BitPat("b????????????????100001???1????00"),
    "C_LHU" -> BitPat("b????????????????100001???0????00"),
    ...
    "C_SH" -> BitPat("b????????????????100011???0????00"),
    "C_ZEXT_B" -> BitPat("b????????????????100111???1100001"),
    "C_ZEXT_H" -> BitPat("b????????????????100111???1101001"),
  )
  val C_ZIHINTNTLType = Map(
    "C_NTL_ALL" -> BitPat("b????????????????1001000000010110"),
    "C_NTL_P1" -> BitPat("b????????????????1001000000001010"),
    "C_NTL_PALL" -> BitPat("b????????????????1001000000001110"),
    "C_NTL_S1" -> BitPat("b????????????????1001000000010010"),
  )
  val ZCB64Type = Map("C_ZEXT_W" -> BitPat("b????????????????100111???1110001"))
  val ZICBOType = Map(
    ...
    "PREFETCH_I" -> BitPat("b???????00000?????110000000010011"),
    "PREFETCH_R" -> BitPat("b???????00001?????110000000010011"),
    "PREFETCH_W" -> BitPat("b???????00011?????110000000010011"),
  )
  val ZBCType = Map(
  ...
  val ZCMTType = Map("CM_JALT" -> BitPat("b????????????????101000????????10"))
  val ZCMPType = Map(
  ...
  val ZBTType = Map(
    "CMIX" -> BitPat("b?????11??????????001?????0110011"),
    "CMOV" -> BitPat("b?????11??????????101?????0110011"),
    "FSL" -> BitPat("b?????10??????????001?????0110011"),
    "FSR" -> BitPat("b?????10??????????101?????0110011"),
  )
  val ZBRType = Map(
    "CRC32_B" -> BitPat("b011000010000?????001?????0010011"),
    "CRC32_H" -> BitPat("b011000010001?????001?????0010011"),
    "CRC32_W" -> BitPat("b011000010010?????001?????0010011"),
    "CRC32C_B" -> BitPat("b011000011000?????001?????0010011"),
    "CRC32C_H" -> BitPat("b011000011001?????001?????0010011"),
    "CRC32C_W" -> BitPat("b011000011010?????001?????0010011"),
  )
  val ZBR64Type = Map(
    "CRC32_D" -> BitPat("b011000010011?????001?????0010011"),
    "CRC32C_D" -> BitPat("b011000011011?????001?????0010011"),
  )
  val ZICSRType = Map(
  ...
  val FType = Map(
    ...
    "FMV_S_X" -> BitPat("b111100000000?????000?????1010011"),
    "FMV_W_X" -> BitPat("b111100000000?????000?????1010011"),
    "FMV_X_S" -> BitPat("b111000000000?????000?????1010011"),
  ...
  val ZBT64Type = Map(
    "FSLW" -> BitPat("b?????10??????????001?????0111011"),
    "FSRI" -> BitPat("b?????1???????????101?????0010011"),
    "FSRIW" -> BitPat("b?????10??????????101?????0011011"),
    "FSRW" -> BitPat("b?????10??????????101?????0111011"),
  )
  val ZBPType = Map(
    "GORC" -> BitPat("b0010100??????????101?????0110011"),
    "GREV" -> BitPat("b0110100??????????101?????0110011"),
    "PACKU" -> BitPat("b0100100??????????100?????0110011"),
    "SHFL" -> BitPat("b0000100??????????001?????0110011"),
    "UNSHFL" -> BitPat("b0000100??????????101?????0110011"),
    "XPERM16" -> BitPat("b0010100??????????110?????0110011"),
    "XPERM4" -> BitPat("b0010100??????????010?????0110011"),
    "XPERM8" -> BitPat("b0010100??????????100?????0110011"),
  )
  val ZBP64Type = Map(
    "GORCI" -> BitPat("b001010???????????101?????0010011"),
    "GORCIW" -> BitPat("b0010100??????????101?????0011011"),
    "GORCW" -> BitPat("b0010100??????????101?????0111011"),
    "GREVI" -> BitPat("b011010???????????101?????0010011"),
    "GREVIW" -> BitPat("b0110100??????????101?????0011011"),
    "GREVW" -> BitPat("b0110100??????????101?????0111011"),
    "PACKUW" -> BitPat("b0100100??????????100?????0111011"),
    "SHFLI" -> BitPat("b0000100??????????001?????0010011"),
    "SHFLW" -> BitPat("b0000100??????????001?????0111011"),
    "UNSHFLI" -> BitPat("b0000100??????????101?????0010011"),
    "UNSHFLW" -> BitPat("b0000100??????????101?????0111011"),
    "XPERM32" -> BitPat("b0010100??????????000?????0110011"),
  )
  val HType = Map(
  ...
  val ZPSFType = Map(
    "KADD64" -> BitPat("b1001000??????????001?????1110111"),
    "KMAR64" -> BitPat("b1001010??????????001?????1110111"),
    "KMSR64" -> BitPat("b1001011??????????001?????1110111"),
    "KSUB64" -> BitPat("b1001001??????????001?????1110111"),
    "MULR64" -> BitPat("b1111000??????????001?????1110111"),
    "MULSR64" -> BitPat("b1110000??????????001?????1110111"),
    "RADD64" -> BitPat("b1000000??????????001?????1110111"),
    "RSUB64" -> BitPat("b1000001??????????001?????1110111"),
    "SMAL" -> BitPat("b0101111??????????001?????1110111"),
    "SMALBB" -> BitPat("b1000100??????????001?????1110111"),
    "SMALBT" -> BitPat("b1001100??????????001?????1110111"),
    "SMALDA" -> BitPat("b1000110??????????001?????1110111"),
    "SMALDRS" -> BitPat("b1001101??????????001?????1110111"),
    "SMALDS" -> BitPat("b1000101??????????001?????1110111"),
    "SMALTT" -> BitPat("b1010100??????????001?????1110111"),
    "SMALXDA" -> BitPat("b1001110??????????001?????1110111"),
    "SMALXDS" -> BitPat("b1010101??????????001?????1110111"),
    "SMAR64" -> BitPat("b1000010??????????001?????1110111"),
    "SMSLDA" -> BitPat("b1010110??????????001?????1110111"),
    "SMSLXDA" -> BitPat("b1011110??????????001?????1110111"),
    "SMSR64" -> BitPat("b1000011??????????001?????1110111"),
    "SMUL16" -> BitPat("b1010000??????????000?????1110111"),
    "SMUL8" -> BitPat("b1010100??????????000?????1110111"),
    "SMULX16" -> BitPat("b1010001??????????000?????1110111"),
    "SMULX8" -> BitPat("b1010101??????????000?????1110111"),
    "UKADD64" -> BitPat("b1011000??????????001?????1110111"),
    "UKMAR64" -> BitPat("b1011010??????????001?????1110111"),
    "UKMSR64" -> BitPat("b1011011??????????001?????1110111"),
    "UKSUB64" -> BitPat("b1011001??????????001?????1110111"),
    "UMAR64" -> BitPat("b1010010??????????001?????1110111"),
    "UMSR64" -> BitPat("b1010011??????????001?????1110111"),
    "UMUL16" -> BitPat("b1011000??????????000?????1110111"),
    "UMUL8" -> BitPat("b1011100??????????000?????1110111"),
    "UMULX16" -> BitPat("b1011001??????????000?????1110111"),
    "UMULX8" -> BitPat("b1011101??????????000?????1110111"),
    "URADD64" -> BitPat("b1010000??????????001?????1110111"),
    "URSUB64" -> BitPat("b1010001??????????001?????1110111"),
  )
  val SMRNMIType = Map("MNRET" -> BitPat("b01110000001000000000000001110011"))
  val ZIHINTNTLType = Map(
    "NTL_ALL" -> BitPat("b00000000010100000000000000110011"),
    "NTL_P1" -> BitPat("b00000000001000000000000000110011"),
    "NTL_PALL" -> BitPat("b00000000001100000000000000110011"),
    "NTL_S1" -> BitPat("b00000000010000000000000000110011"),
  )
  val ZBPBO64Type = Map("REV" -> BitPat("b011010111111?????101?????0010011"))
  val ZKS64Type = Map("REV8" -> BitPat("b011010111000?????101?????0010011"))
  val ZBPBOType = Map("REV8_H" -> BitPat("b011010001000?????101?????0010011"))
  val SType = Map(
  ...
  val BType = Map(
    "SLO" -> BitPat("b0010000??????????001?????0110011"),
    "SLOI" -> BitPat("b001000???????????001?????0010011"),
    "SRO" -> BitPat("b0010000??????????101?????0110011"),
    "SROI" -> BitPat("b001000???????????101?????0010011"),
  )
  val B64Type = Map(
    "SLOIW" -> BitPat("b0010000??????????001?????0011011"),
    "SLOW" -> BitPat("b0010000??????????001?????0111011"),
    "SROIW" -> BitPat("b0010000??????????101?????0011011"),
    "SROW" -> BitPat("b0010000??????????101?????0111011"),
  )
  val ZKSHType = Map(
  ...
  val V_ALIASESType = Map(
    "VFREDSUM_VS" -> BitPat("b000001???????????001?????1010111"),
    "VFWREDSUM_VS" -> BitPat("b110001???????????001?????1010111"),
    "VL1R_V" -> BitPat("b000000101000?????000?????0000111"),
    "VL2R_V" -> BitPat("b001000101000?????000?????0000111"),
    "VL4R_V" -> BitPat("b011000101000?????000?????0000111"),
    "VL8R_V" -> BitPat("b111000101000?????000?????0000111"),
    "VLE1_V" -> BitPat("b000000101011?????000?????0000111"),
    "VMANDNOT_MM" -> BitPat("b011000???????????010?????1010111"),
    "VMORNOT_MM" -> BitPat("b011100???????????010?????1010111"),
    "VPOPC_M" -> BitPat("b010000??????10000010?????1010111"),
    "VSE1_V" -> BitPat("b000000101011?????000?????0100111"),
  )
